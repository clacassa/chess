...
const std::wstring clr_display(L"\x1b[11F\x1b[J");
const std::wstring erase_line(L"\x1b[100D\x1b[A\x1b[2K");
const std::wstring italic(L"\x1b[3m");

/* Special squares */
const std::wstring empty_square(L"  ");
const std::wstring light_target_sqr(L"\x1b[48;5;106m");
const std::wstring dark_target_sqr(L"\x1b[48;5;100m");
...
// const std::wstring w_king(L"\x1b[30m\u2654 ");
// const std::wstring w_queen(L"\x1b[30m\u2655 ");
// const std::wstring w_rook(L"\x1b[30m\u2656 ");
// const std::wstring w_bishop(L"\x1b[30m\u2657 ");
// const std::wstring w_knight(L"\x1b[30m\u2658 ");
// const std::wstring w_pawn(L"\x1b[30m\u2659 ");
...
const std::wstring light_grey(L"\x1b[48;5;251m");
...
const std::wstring lilas(L"\x1b[48;5;135m");

/* Color schemes */
const ColorScheme standard(beige, brown);
const ColorScheme gnu_chess(light_grey, lilas);
